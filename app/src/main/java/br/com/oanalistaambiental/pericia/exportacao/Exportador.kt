...
object Exportador {
     ...
     *
     * BUG corrigido: com mais de um arquivo o tipo virava sempre "*\/*", que o WhatsApp trata
     * mal em alguns Android (o app nem aparece no seletor). Quando todos os arquivos são do
     * mesmo tipo (o caso comum: só fotos), usa esse tipo especifico — "*\/*" fica so para
     * mistura de verdade.
     *
